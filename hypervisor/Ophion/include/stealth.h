...
//
//
// DISABLED — causes PAGE_FAULT_IN_NONPAGED_AREA on i5-13600KF
// Re-enable once base HV is verified stable on this hardware
//
#define USE_PRIVATE_HOST_CR3                0

//
// private host IDT for VMCS_HOST_IDTR_BASE
// DISABLED for stability — re-enable after CR3 is stable
//
#define USE_PRIVATE_HOST_IDT                0

// DISABLED for stability
#define USE_PRIVATE_HOST_GDT                0
